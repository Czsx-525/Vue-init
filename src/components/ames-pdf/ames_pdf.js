...
var pdfjsViewer = window.pdfjsViewer || {}
...
pdfjsLib.GlobalWorkerOptions.workerSrc = '/static/pdfjs-dist/build/pdf.worker.js' // js文件放public下面
  ...
  initUI: function pdfViewInitUI () {
    ...
    eventBus.on('pagechanging',
      function (evt) {
        ...
        // if (page >= numPages) {
        //   window.pdfjsViewer.scroll2Bottom()
        // }
